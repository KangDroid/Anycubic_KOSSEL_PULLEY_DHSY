...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -19.6
...
#define INVERT_X_DIR true // revised DELTA does not invert
#define INVERT_Y_DIR true // revised
#define INVERT_Z_DIR true // revised
