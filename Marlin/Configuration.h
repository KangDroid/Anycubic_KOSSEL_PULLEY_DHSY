...
#define DELTA
  ...
  #define DELTA_HEIGHT 339.25 // get this value from auto calibrate
...
#define DELTA_CARRIAGE_OFFSET 20.6 // mm
  ...
  #define DELTA_RADIUS 90 //mm  Get this value from auto calibrate
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define DELTA_PROBEABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 10) //80
  ...
  #define UBL_PROBE_PT_1_X _PX(80, 0)   // Probing points for 3-Point leveling of the mesh
  #define UBL_PROBE_PT_1_Y _PY(80, 0)
  #define UBL_PROBE_PT_2_X _PX(80, 120)
  #define UBL_PROBE_PT_2_Y _PY(80, 120)
  #define UBL_PROBE_PT_3_X _PX(80, 240)
  #define UBL_PROBE_PT_3_Y _PY(80, 240)
