 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT {100,100,400,95.82}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE {250, 250, 9, 110}
...
#define DEFAULT_TRAVEL_ACCELERATION 1300
