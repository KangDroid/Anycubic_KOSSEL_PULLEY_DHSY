...
void kill_screen(const char* lcd_msg) {
  ...
  void advanced_control_menu() {
	...
	MENU_MULTIPLIER_ITEM_EDIT(int8, MSG_Z_HOME_FR_RATIO, &z_homing_speed_ratio, 4, 100);
	MENU_MULTIPLIER_ITEM_EDIT(int8, MSG_Z_HOME_FR_BASE, &z_homing_speed_base, 10, 100);
